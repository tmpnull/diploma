...
return [
    ...
    */
    ...
    'gt'                   => [
        ...
        'file'    => ':attribute должен быть больше чем :value килобаайт.',
    ...
    'gte'                  => [
        ...
        'file'    => ':attribute должен быть больше чем or equal :value килобаайт.',
    ...
    'lt'                   => [
        ...
        'file'    => 'The :attribute должен быть меньше чем :value килобаайт.',
        'string'  => 'The :attribute должен быть меньше чем :value символов.',
        'array'   => 'The :attribute должен содержать меньше чем :value элементов.',
    ],
    'lte'                  => [
        'numeric' => 'The :attribute должен быть меньше чем or equal :value.',
        'file'    => 'The :attribute должен быть меньше чем or equal :value килобаайт.',
        'string'  => 'The :attribute должен быть меньше чем or equal :value символов.',
        'array'   => 'The :attribute не должен содержать :value или менее элементов.',
    ],
    'max'                  => [
    ...
    'min'                  => [
        ...
        'file'    => ':attribute должно быть at least :min килобаайт.',
        'string'  => ':attribute должно быть at least :min символов.',
